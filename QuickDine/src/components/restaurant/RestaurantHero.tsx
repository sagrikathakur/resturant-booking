...
import { assets, dummyRating, dummyReviewCount } from "../../assets/assets.ts";
                    ...
                    <div className="space-y-3">
                        <div className="flex flex-wrap gap-2 items-center">
                            ...
                            {restaurant.exclusive && (
                                <span className="text-[10px] font-medium tracking-widest text-white bg-black/60 backdrop-blur-sm border border-white/20 py-1 px-3 uppercase">
                                    EXCLUSIVE CLUB
                                </span>
                            )}
                        </div>
